...
class Hangman extends Component {
  ...
  */
  ...
  /** handleGuest: handle a guessed letter:
    ...
    - Using the event object as an argument we can access the letter guessed
    by referencing the value attribute we assigned it in generateButtons()
  */
  handleGuess(evt) {
